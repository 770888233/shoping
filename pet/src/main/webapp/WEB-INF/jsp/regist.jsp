							...
							<tbody>
								...
								<tr>
									...
									<td><input type="password" id="rePassword"
										...
										autocomplete="off" onclick="checkForm()"></td>
								</tr>
								<tr>
								...
								<tr>
									...
									<td>
										<span class="fieldSet"> 
										<input type="text" id="captcha" name="checkImg" class="text captcha" maxlength="4" autocomplete="off" onclick="checkForm1()">
